...
find . \( -name "Makefile" -or -name "*.py" -or -name "*.pyx" -or -name "*.c" -or -name "*.cpp" -or -name "*.h" -or -name "*.hpp" -or -name "*.nsi" -or -name "*.nsh" -or -name "*.sh" -or -name "*.xml" -or -name "*.txt" \) -exec dos2unix {} \;
