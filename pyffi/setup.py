...
setup(
    ...
    scripts = ['pyffipostinstallation.py', 'scripts/NIF/ffvt3rskinpartition.py', 'scripts/NIF/nifmakehsl.py', 'scripts/NIF/niftoaster.py', 'scripts/NIF/nifoptimize.py', 'scripts/NIF/niftexdump.py', 'scripts/NIF/nifdump.py', 'scripts/NIF/niftemplate.py', 'scripts/CGF/cgftoaster.py', 'scripts/KFM/kfmtoaster.py', 'scripts/qskope.py'],
    author = "Amorilia",
