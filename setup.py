...
setup(
    ...
    packages = ['PyFFI', 'PyFFI.ObjectModels', 'PyFFI.ObjectModels.XML', 'PyFFI.ObjectModels.XSD', 'PyFFI.Utils', 'PyFFI.Formats', 'PyFFI.Formats.NIF', 'PyFFI.Formats.KFM', 'PyFFI.Formats.CGF', 'PyFFI.Formats.DDS', 'PyFFI.Formats.TGA', 'PyFFI.Spells', 'PyFFI.Spells.CGF', 'PyFFI.Spells.NIF', 'PyFFI.QSkope', 'PyFFI.Formats.DAE'],
