...
PyFFI supports the NetImmerse/Gamebryo NIF and KFM formats, CryTek's
CGF format, and the DDS format. Many tools for files used by 3D
games, such as a stripifier, and a tangent space calculator, are
included in PyFFI as well.
...
setup(
    ...
    packages = ['PyFFI', 'PyFFI.Bases', 'PyFFI.Utils', 'PyFFI.NIF', 'PyFFI.KFM', 'PyFFI.CGF', 'PyFFI.DDS', 'NifTester', 'NifTester.hacking', 'NifTester.validate', 'NifTester.surgery', 'NifVis', 'NifVis.lizers', 'CgfTester', 'CgfTester.hacking', 'CgfTester.validate', 'CgfTester.surgery', 'KfmTester', 'KfmTester.hacking', 'KfmTester.validate', 'KfmTester.surgery', 'qskopelib'],
