...
from pyffi.object_models.niftoolsxml import BitStructAttribute as Attr
...
class Flags(BitStructBase):
    _numbytes = 1
    _attrs = [Attr.create(SimpleFormat, dict(name='a', numbits='3')),
              Attr.create(SimpleFormat, dict(name='b', numbits='1'))]
